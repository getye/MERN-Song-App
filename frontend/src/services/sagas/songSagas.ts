...
function* fetchSongs() {
  try {
    const response: { data: Song[] } = yield call(axios.get, 'https://mern-song-app-8gjt.onrender.com/viewsongs');
...
function* addSong(action: AddSongRequestAction) {
  try {
    const response: { data: Song } = yield call(axios.post, 'https://mern-song-app-8gjt.onrender.com/addsong', action.payload);
...
function* updateSong(action: UpdateSongRequestAction) {
  try {
    ...
    const response: { data: Song } = yield call(axios.put, `https://mern-song-app-8gjt.onrender.com/updatesong/${id}`, song);
...
function* deleteSong(action: DeleteSongRequestAction) {
  try {
    yield call(axios.delete, `https://mern-song-app-8gjt.onrender.com/songs/${action.payload}`);
