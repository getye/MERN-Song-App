...
function* fetchSongs() {
  try {
    const response: { data: Song[] } = yield call(axios.get, 'https://mern-song-app-rvkl.onrender.com/viewsongs');
...
function* addSong(action: AddSongRequestAction) {
  try {
    const response: { data: Song } = yield call(axios.post, 'https://mern-song-app-rvkl.onrender.com/addsong', action.payload);
...
function* updateSong(action: UpdateSongRequestAction) {
  try {
    ...
    const response: { data: Song } = yield call(axios.put, `https://mern-song-app-rvkl.onrender.com/updatesong/${id}`, song);
...
function* deleteSong(action: DeleteSongRequestAction) {
  try {
    yield call(axios.delete, `https://mern-song-app-rvkl.onrender.com/songs/${action.payload}`);
